...
int TrackerMuonId_TMVATemplate( TString myMethodList = "" ){
   ...
   TFile *input(0);
	//TString fname = "../Ntuples/MuonPionTree_combined_2017.root";	// Input file
   // InputFileTag
   ...
   // Create a new root output file.
	//TString outfileName = "TrackerMuonId_TMVATemplate_2017_Output.root";   // Output file
   // OutputFileTag
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   // Ds signal
   // ____________
   //TString factoryName = "TrackerMuonId_TMVATemplate_2017";   
   // FactoryNameTag
   ...
   TCut mycutb = "fake==1 && isGlobal==0 && isTracker==1 && isPF==1";
	TCut mycuts = "fake==0 && isGlobal==0 && isTracker==1 && isPF==1";
...
int main( int argc, char** argv )
{
   ...
   return TrackerMuonId_TMVATemplate(methodList);
}
