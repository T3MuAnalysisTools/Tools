...
BDTcut Get_BDT_cut(TString categ, TString filePref, TString method, TString TrainType = "DS") 
{
  //Check on input argument
  //  if(strcmp(categ, "mu3mu") != 0 && strcmp(categ, "e3mu") != 0 && strcmp(categ, "tau3mu") != 0 ){
  //    cout << "Please choose between 'mu3mu', 'e3mu' or  ''" << endl;
  //  return{-999,-999};
  //  }
      
  //pull path of root files generated by TMVA
  //  TString file_name= "TMVATrees_Run2017_MC_Output_unbiased_"+categ+".root";
  
  TString file_name=  "category_" + filePref+".root";//filePref+"_"+categ+".root";//"TMVATrees_Run2017_reweightedMC_2017unbiased_Output_"+categ+".root";
  ...
  Double_t sig_norm = 0.72; //average normalization factor for the three signal samples
  TFile *f = new TFile(file_name,"READ");
  TH1F *h_test_signal;
  TH1F *h_test_bkg;

  //high granularity BDT scores
  //  std::cout<< filePref+"_"+categ+"_"+TrainType+"/Method_"+method+"/"+method+"/MVA_"+method+"_S_high" <<std::endl;
  //  h_test_signal = (TH1F*)f->Get(filePref+"_"+categ+"_"+TrainType+"/Method_"+method+"/"+method+"/MVA_"+method+"_S_high");
  //  h_test_bkg = (TH1F*)f->Get(filePref+"_"+categ+"_"+TrainType+"/Method_"+method+"/"+method+"/MVA_"+method+"_B_high");



  std::cout<< "output_"+filePref+"/Method_"+method+"/"+method+"/MVA_"+method+"_S_high" <<std::endl;
  h_test_signal = (TH1F*)f->Get("output_"+filePref+"/Method_"+method+"/"+method+"/MVA_"+method+"_S_high");
  //h_test_signal = (TH1F*)f->Get("output_0_ZTT_tau3mu/Method_BDT/BDT/MVA_BDT_S_high");
  h_test_bkg    = (TH1F*)f->Get("output_"+filePref+"/Method_"+method+"/"+method+"/MVA_"+method+"_B_high");
  h_test_signal->Draw();
