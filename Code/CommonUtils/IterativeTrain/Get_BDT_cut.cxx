...
BDTcut Get_BDT_cut(TString categ, TString filePref, TString method) 
{
  ...
  TString file_name=  filePref+"_"+categ+".root";//"TMVATrees_Run2017_reweightedMC_2017unbiased_Output_"+categ+".root";
  ...
  std::cout<< "output_"+filePref+"_"+categ+"/Method_"+method+"/"+method+"/MVA_"+method+"_S_high" <<std::endl;
  h_test_signal = (TH1F*)f->Get("output_"+filePref+"_"+categ+"/Method_"+method+"/"+method+"/MVA_"+method+"_S_high");
  h_test_bkg = (TH1F*)f->Get("output_"+filePref+"_"+categ+"/Method_"+method+"/"+method+"/MVA_"+method+"_B_high");
  //  h_test_bkg->Draw();
