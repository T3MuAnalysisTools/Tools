...
"""
varsets0 = {'ZTT_tau_NoCV_3mu':['var_mu2_pT','var_mu3_eta','var_TripletPT','var_Tau3MuIsolation',
                         'var_Tau_pT',
            ...
            'ZTT_mu3mu':['var_mu2_pT','var_mu2_eta','var_TripletPT','var_Tau3MuIsolation',
                         'var_Muon_pT',
            ...
            'ZTT_e3mu':['var_TripletPT','var_Tau3MuIsolation',
                         'var_Electron_pT',
                         'var_SVPVTauDirAngle','var_ThreeMuVertexChi2KF','var_DeltaPhi','var_MinDrToIsoTrack',
                         'var_VisMass', 'var_DiTauMass_Collinear',
...
varsets0 = {'ZTT_tau_NoCV_3mu':['var_TripletPT', 'var_TripletEta', 'var_Tau3MuIsolation', 'var_FLSignificance', 'var_ThreeMuVertexChi2KF', 
            'var_MinDrToIsoTrack', 'var_VisMass'],
            
            'ZTT_tau_CV_3mu':['var_TripletPT', 'var_Tau3MuIsolation', 'var_Tau_eta', 'var_SVPVTauDirAngle', 'var_ThreeMuVertexChi2KF', 
             'var_DeltaPhi', 'var_MinDrToIsoTrack', 'var_VisMass'],
             
            'ZTT_mu3mu':['var_TripletPT', 'var_Tau3MuIsolation', 'var_Muon_pT', 'var_FLSignificance', 'var_SVPVTauDirAngle', 
            ...
            'ZTT_e3mu':['var_TripletPT', 'var_Tau3MuIsolation', 'var_Electron_pT', 'var_ThreeMuVertexChi2KF', 'var_DeltaPhi', 
