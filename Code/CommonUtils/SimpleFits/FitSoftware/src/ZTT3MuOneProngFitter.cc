...
double ZTT3MuOneProngFitter::MassConstraint_ = 125.2;
bool ZTT3MuOneProngFitter::useCollinearityTauOneProng_ = false;

ZTT3MuOneProngFitter::ZTT3MuOneProngFitter(LorentzVectorParticle TauThreeProng, LorentzVectorParticle ThreeProng, TrackParticle OneProngTrack, PTObject ResPtEstimate, TVector3 PVertex, TMatrixTSym<double> VertexCov):
  LagrangeMultipliersFitter()
{
  ZTT3MuOneProngFitter(TauThreeProng, ThreeProng, OneProngTrack, ResPtEstimate, PVertex, VertexCov, ZTT3MuOneProngFitter::MassConstraint_);
}
...
void ZTT3MuOneProngFitter::Configure(LorentzVectorParticle TauThreeProng, LorentzVectorParticle ThreeProng, TrackParticle OneProngTrack, TVector3 PVertex, TMatrixTSym<double> VertexCov){
  ...
  expcov_=ErrorMatrixPropagator::PropagateError(&ZTT3MuOneProngFitter::ComputeInitalExpPar,inpar,incov);
  ...
  cov_0=ErrorMatrixPropagator::PropagateError(&ZTT3MuOneProngFitter::ComputeExpParToPar,exppar_,expcov_);
  ...
  cova_0=ErrorMatrixPropagator::PropagateError(&ZTT3MuOneProngFitter::ComputeExpParToPara,exppar_,expcov_);
...
TMatrixT<double> ZTT3MuOneProngFitter::ComputeInitalExpPar(TMatrixT<double> &inpar){
...
bool ZTT3MuOneProngFitter::Fit(){
  ...
  if (fittingMode_ == FittingProc::Standard){
    ...
    ZTT3MuOneProngFitterChiSquareFunctionUpdator updator(this);
...
TMatrixT<double> ZTT3MuOneProngFitter::ComputeExpParToPar(TMatrixT<double> &inpar){
  TMatrixT<double> outpar(npar,1);
  for(int i=0;i<npar;i++){outpar(i,0)=inpar(i,0);}
  return outpar;
}
TMatrixT<double> ZTT3MuOneProngFitter::ComputeExpParToPara(TMatrixT<double> &inpar){
  TMatrixT<double> outpar(npartr,1);
  for(int i=0;i<npartr;i++){outpar(i,0)=inpar(i,0);}
  return outpar;
}

TMatrixT<double> ZTT3MuOneProngFitter::ComputeExpParToParb(TMatrixT<double> &inpar){
  TMatrixT<double> outpar(npartr,1);
  int offset = 3;
...
TMatrixT<double> ZTT3MuOneProngFitter::ComputeTauOneProngLorentzVectorPar(TMatrixT<double> &inpar){
...
TMatrixT<double> ZTT3MuOneProngFitter::ComputeTauThreeProngLorentzVectorPar(TMatrixT<double> &inpar){
  //  start with index 3 to fill only momenta part
  TMatrixT<double> outpar(7,1);
  outpar(LorentzVectorParticle::vx,0)=0;
  outpar(LorentzVectorParticle::vy,0)=0;
...
TMatrixT<double> ZTT3MuOneProngFitter::ComputeMotherLorentzVectorPar(TMatrixT<double> &inpar){
...
void ZTT3MuOneProngFitter::UpdateExpandedPar(){
...
std::vector<LorentzVectorParticle> ZTT3MuOneProngFitter::GetReFitDaughters(){
  ...
  TMatrixTSym<double> TauThreeProngCov=ErrorMatrixPropagator::PropagateError(&ZTT3MuOneProngFitter::ComputeTauThreeProngLorentzVectorPar,exppar_,expcov_);
  ...
  TMatrixTSym<double> TauOneProngcov=ErrorMatrixPropagator::PropagateError(&ZTT3MuOneProngFitter::ComputeTauOneProngLorentzVectorPar,exppar_,expcov_);
  for(int i=0; i<LorentzVectorParticle::NVertex; i++){
    for(int j=0; j<LorentzVectorParticle::NVertex; j++){
...
LorentzVectorParticle ZTT3MuOneProngFitter::GetMother(){
  UpdateExpandedPar();
  double c(0),b(0);
  ...
  TMatrixTSym<double> MotherCov=ErrorMatrixPropagator::PropagateError(&ZTT3MuOneProngFitter::ComputeMotherLorentzVectorPar,exppar_,expcov_);

  return LorentzVectorParticle(Mother,MotherCov,PDGInfo::Z0,c,b);
}

TVectorD ZTT3MuOneProngFitter::HardValue(TVectorD &va,TVectorD &vb,bool debug){
...
TVectorD ZTT3MuOneProngFitter::SoftValue(TVectorD &va,TVectorD &vb,bool debug){
  TLorentzVector TauThreeProng,TauOneProng;
  CovertParToObjects(va,vb,TauThreeProng,TauOneProng);
...
void ZTT3MuOneProngFitter::CovertParToObjects(TVectorD &va,TVectorD &vb,TLorentzVector &TauThreeProng,TLorentzVector &TauOneProng){
...
LorentzVectorParticle ZTT3MuOneProngFitter::TauOneProngStartingPoint(TrackParticle OneProngTrack, LorentzVectorParticle TauThreeProng, TVector3 PV,TMatrixTSym<double>  PVCov, TVector3 SV, TMatrixTSym<double>  SVCov){
  ...
  tau1prongdirectionError = ErrorMatrixPropagator::PropagateError(&ZTT3MuOneProngFitter::EstimateTauDirectionAdvanced,ConfigureInitialAdvancedParameters(OneProngTrack, PV, TauThreeProng),ConfigureInitialAdvancedParameterErrors(OneProngTrack, PVCov, TauThreeProng.getCovMatrix()));
  ...
  TauKinErrorNumerical = ErrorMatrixPropagator::PropagateError(&ZTT3MuOneProngFitter::EstimateTauKinematic,ConfigureKinematicParameters(tau1prongdirection,TauThreeProng),ConfigureKinematicParameterErrors(tau1prongdirectionError,TauThreeProng));
...
LorentzVectorParticle ZTT3MuOneProngFitter::TauOneProngStartingPointwithFullRecoil(TrackParticle OneProngTrack, LorentzVectorParticle TauThreeProng, PTObject METminusNeutrino, TVector3 PV, TMatrixTSym<double>  PVCov, TVector3 SV, TMatrixTSym<double>  SVCov){
  ...
  TauKinErrorNumerical = ErrorMatrixPropagator::PropagateError(&ZTT3MuOneProngFitter::EstimateTauKinematicFullRecoil,kinematicparameters,kinematicparametererrors);
...
TMatrixT<double> ZTT3MuOneProngFitter::EstimateTauDirectionAdvanced(TMatrixT<double> &inpar){
...
TMatrixT<double> ZTT3MuOneProngFitter::EstimateTauKinematic(TMatrixT<double> &inpar){
...
TMatrixT<double> ZTT3MuOneProngFitter::ConfigureParameters(TrackParticle OneProngTrack, std::pair<double, double> phiAngle){
...
TMatrixT<double> ZTT3MuOneProngFitter::ConfigureParameterErrors(TrackParticle OneProngTrack, std::pair<double, double> phiAngle){
    TMatrixT<double>  Cov;
    Cov.ResizeTo(5,5);
...
TMatrixT<double> ZTT3MuOneProngFitter::ConfigureInitialAdvancedParameters(TrackParticle OneProngTrack,  TVector3 PV, LorentzVectorParticle TauThreeProng){
...
TMatrixTSym<double>
ZTT3MuOneProngFitter::ConfigureInitialAdvancedParameterErrors(TrackParticle OneProngTrack, TMatrixTSym<double> PVCov, TMatrixTSym<double> TauThreeProngCov){
...
TMatrixT<double> ZTT3MuOneProngFitter::ConfigureKinematicParameters(TMatrixT<double>  TauOneProngDir, LorentzVectorParticle TauThreeProng){
  TMatrixT<double>    outpar;
  outpar.ResizeTo(5,1);
...
TMatrixTSym<double> ZTT3MuOneProngFitter::ConfigureKinematicParameterErrors(TMatrixTSym<double>  TauOneProngDirError, LorentzVectorParticle TauThreeProng){
...
std::pair<double, double> ZTT3MuOneProngFitter::EstimatePhiAngle( TVector3 dir, TVector3 dirE){
...
TMatrixT<double> ZTT3MuOneProngFitter::ComputeAngleCovarianceAnalytically(TrackParticle OneProngTrack, std::pair<double, double> phiAngle,  TVector3 PV, TVector3 SV, LorentzVectorParticle  TauThreeProng){
  TMatrixT<double>    outpar;
  outpar.ResizeTo(3,3);
...
LorentzVectorParticle ZTT3MuOneProngFitter::GetTauOneProngEstimate(){
  return particles_.at(1);
}

TMatrixT<double> ZTT3MuOneProngFitter::ConfigureKinematicParametersFullRecoil(TrackParticle OneProngTrack, TVector3 PV, LorentzVectorParticle TauThreeProng, PTObject METMinusNeutrino){
  TMatrixT<double> outpar;
...
TMatrixTSym<double> ZTT3MuOneProngFitter::ConfigureKinematicParameterErrorsFullRecoil(TrackParticle OneProngTrack, TMatrixTSym<double> PVCov, LorentzVectorParticle TauThreeProng, PTObject METMinusNeutrino){
  TMatrixTSym<double>  Cov;
    Cov.ResizeTo(12,12);
...
TMatrixT<double> ZTT3MuOneProngFitter::EstimateTauKinematicFullRecoil(TMatrixT<double> &inpar){
  TMatrixT<double> outpar;
  outpar.ResizeTo(6,1);
...
TMatrixDSym ZTT3MuOneProngFitter::EstimateTauKinematicErrorFullRecoil(LorentzVectorParticle TauThreeProng, TLorentzVector TauOneProng, PTObject ResPtEstimate){
...
double ZTT3MuOneProngFitter::CosThetaTauOneProng(TLorentzVector TauOneProng){
...
bool ZTT3MuOneProngFitter::isConverged(){
  if(!useFullRecoil_){
...
TString ZTT3MuOneProngFitter::ParName(int par){
  switch (par){
