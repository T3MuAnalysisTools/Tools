#ifndef ZTT3MuOneProngFitter_H
#define ZTT3MuOneProngFitter_H
...
class ZTT3MuOneProngFitter : public LagrangeMultipliersFitter{
 public:
  ZTT3MuOneProngFitter(LorentzVectorParticle TauThreeProng, LorentzVectorParticle ThreeProng, TrackParticle OneProngTrack, PTObject ResPtEstimate, TVector3 PVertex, TMatrixTSym<double> VertexCov);
  ZTT3MuOneProngFitter(LorentzVectorParticle TauThreeProng, LorentzVectorParticle ThreeProng, TrackParticle OneProngTrack, PTObject ResPtEstimate, TVector3 PVertex, TMatrixTSym<double> VertexCov, double MassConstraint);
  virtual ~ZTT3MuOneProngFitter(){};
