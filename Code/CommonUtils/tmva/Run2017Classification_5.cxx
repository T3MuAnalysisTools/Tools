...
int Run2017Classification_5( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_5.root";   // output file
...
TString factoryName = "Run2017Classification_5";   
...
dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
"nTrain_Signal=5788:nTrain_Background=10551:SplitMode=Random:NormMode=NumEvents:!V");
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_5(methodList);
}
