...
int Run2017Classification_biased_Endcap( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_biased_Endcap.root";   // output file
...
TString factoryName = "Run2017Classification_biased_Endcap";   
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_biased_Endcap(methodList);
}
