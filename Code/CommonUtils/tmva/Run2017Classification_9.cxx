...
int Run2017Classification_9( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_9.root";   // output file
...
TString factoryName = "Run2017Classification_9";   
...
TCut mycutb = "( (category==6 || category==3) && MC==0)";
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_9(methodList);
}
