...
int TMVAClassification_Veto_2017unbiased_Barrel( TString myMethodList = "" ){
...
TString outfileName = "TMVAClassification_Veto_2017unbiased_Barrel_Output.root";   // Output file
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   // Ds signal
   // ____________
TString factoryName = "TMVAClassification_Veto_2017unbiased_Barrel";   TMVA::Factory *factory = new TMVA::Factory( factoryName, outputFile,
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_Veto_2017unbiased_Barrel(methodList);
}
