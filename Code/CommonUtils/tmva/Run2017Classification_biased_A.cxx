...
int Run2017Classification_biased_A( TString myMethodList = "" )
{
   ...
   TFile *input(0);
TString fname = "../../macros/TMVATrees_Run2017_MC.root";   // input file
...
TString outfileName = "TMVATrees_Run2017_MC_Output_biased_A.root";   // output file
...
TString factoryName = "Run2017Classification_biased_A";   
   ...
   // Add signal and background variables
...
TCut mycutb = "( (category==4 || category==1) && var_MaxD0Significance<100 && var_MaxD0Significance>=0 && MC==0)";
TCut mycuts = "category==1 && MC==1 && var_MaxD0Significance<100 && var_MaxD0Significance>=0";
...
dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
"nTrain_Signal=3103:nTrain_Background=1343:SplitMode=Random:NormMode=NumEvents:!V");
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_biased_A(methodList);
}
