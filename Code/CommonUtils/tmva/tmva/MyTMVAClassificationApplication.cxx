...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   TString fname = "TMVAInput_Signal.root";

   // TString fname = "TMVATrees.root";
   ...
   for (Long64_t ievt=0; ievt<theTree->GetEntries();ievt++) {
      ...
      std::cout<<" var1  &&  var 2   "<< userVar1<< "   "<< userVar2<< std::endl;
      var1 = userVar1;
      var2 = userVar2;
      ...
      if (Use["BDT"          ]){   histBdt    ->Fill( reader->EvaluateMVA( "BDT method"           ) ); std::cout<<"  mva:  "<<  reader->EvaluateMVA("BDT method") << std::endl;} 
