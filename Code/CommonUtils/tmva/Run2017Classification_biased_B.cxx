...
int Run2017Classification_biased_B( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_biased_B.root";   // output file
...
TString factoryName = "Run2017Classification_biased_B";   
...
TCut mycutb = "( (category==5 || category==2) && var_MaxD0Significance<100 && var_MaxD0Significance>=0 && MC==0)";
TCut mycuts = "category==2 && MC==1";
...
dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
"nTrain_Signal=5788:nTrain_Background=3173:SplitMode=Random:NormMode=NumEvents:!V");
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_biased_B(methodList);
}
