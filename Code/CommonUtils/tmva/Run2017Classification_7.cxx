...
int Run2017Classification_7( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_7.root";   // output file
...
TString factoryName = "Run2017Classification_7";   
   ...
   dataloader->AddVariable("var_Eta_au","Variable Eta_au","units", 'F' );
...
TCut mycutb = "( (category==4 || category==1) && MC==0)";
TCut mycuts = "category==1 && MC==1";
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_7(methodList);
}
