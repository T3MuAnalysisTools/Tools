...
int Run2017Classification_8( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_8.root";   // output file
...
TString factoryName = "Run2017Classification_8";   
...
TCut mycutb = "( (category==5 || category==2) && MC==0)";
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_8(methodList);
}
