...
int TMVAReweighted_8( TString myMethodList = "" ){
   ...
   TFile *input(0);
	TString fname = "../../macros/TMVATrees_Run2017_MC_separate.root";   // input file
   ...
   TString outfileName( "TMVATrees_Run2017_reweightedMC_Output_8.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   // Ds signal
   // ____________
   TMVA::Factory *factory = new TMVA::Factory( "TMVABackgroundMC", outputFile,
  ...
  // dataloader->AddVariable("var_IsolationMinDist","Variable IsolationMinDist","units", 'F' );
	...
	TCut mycutb = "( (category==5 || category==2) && abs(var_MaxD0Significance)<100 && MC==0)";
	TCut mycuts = "category==2 && abs(var_MaxD0Significance)<100 && MC==1";
...
int main( int argc, char** argv )
{
   ...
   return TMVAReweighted_8(methodList);
}
