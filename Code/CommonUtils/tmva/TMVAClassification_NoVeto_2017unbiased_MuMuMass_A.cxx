...
int TMVAClassification_NoVeto_2017unbiased_MuMuMass_A( TString myMethodList = "" ){
...
TString outfileName = "TMVAClassification_NoVeto_2017unbiased_MuMuMass_A_Output.root";   // Output file
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   // Ds signal
   // ____________
TString factoryName = "TMVAClassification_NoVeto_2017unbiased_MuMuMass_A";   TMVA::Factory *factory = new TMVA::Factory( factoryName, outputFile,
   ...
   dataloader->AddVariable("var_phiMass","Variable phiMass","units", 'F' );
   dataloader->AddVariable("var_omegaMass","Variable omegaMass","units", 'F' );
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_NoVeto_2017unbiased_MuMuMass_A(methodList);
}
