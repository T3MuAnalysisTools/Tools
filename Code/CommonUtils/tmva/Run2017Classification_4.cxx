...
int Run2017Classification_4( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_4.root";   // output file
...
TString factoryName = "Run2017Classification_4";   
...
dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
"nTrain_Signal=3103:nTrain_Background=5007:SplitMode=Random:NormMode=NumEvents:!V");
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_4(methodList);
}
