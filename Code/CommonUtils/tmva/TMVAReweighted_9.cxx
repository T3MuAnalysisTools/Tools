...
int TMVAReweighted_9( TString myMethodList = "" ){
   ...
   TString outfileName( "TMVATrees_Run2017_reweightedMC_Output_9.root" );
   ...
   //dataloader->AddVariable("var_IsolationMinDist","Variable IsolationMinDist","units", 'F' );
	...
	TCut mycutb = "( (category==6 || category==3) && abs(var_MaxD0Significance)<100 && MC==0)";
	TCut mycuts = "category==3 && abs(var_MaxD0Significance)<100 && MC==1";
...
int main( int argc, char** argv )
{
   ...
   return TMVAReweighted_9(methodList);
}
