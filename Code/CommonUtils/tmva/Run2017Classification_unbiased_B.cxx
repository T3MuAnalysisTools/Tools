...
int Run2017Classification_unbiased_B( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_unbiased_B.root";   // output file
...
TString factoryName = "Run2017Classification_unbiased_B";   
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_unbiased_B(methodList);
}
