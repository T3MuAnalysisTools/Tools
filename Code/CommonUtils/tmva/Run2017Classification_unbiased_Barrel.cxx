...
int Run2017Classification_unbiased_Barrel( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_unbiased_Barrel.root";   // output file
...
TString factoryName = "Run2017Classification_unbiased_Barrel";   
...
TCut mycutb = "( abs(var_Eta_au)<1.2 && abs(var_MaxD0Significance)<100 && var_MaxD0Significance>=0 && MC==0)";
TCut mycuts = " abs(var_Eta_au)<1.2 && MC==1 && var_MaxD0Significance<100 && var_MaxD0Significance>=0";
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_unbiased_Barrel(methodList);
}
