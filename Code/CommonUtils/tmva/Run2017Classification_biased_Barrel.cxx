...
int Run2017Classification_biased_Barrel( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_biased_Barrel.root";   // output file
...
TString factoryName = "Run2017Classification_biased_Barrel";   
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_biased_Barrel(methodList);
}
