...
int TMVAReweighted_7( TString myMethodList = "" ){
   ...
   TString outfileName( "TMVATrees_Run2017_reweightedMC_Output_7.root" );
  ...
  // dataloader->AddVariable("var_IsolationMinDist","Variable IsolationMinDist","units", 'F' );
	...
	TCut mycutb = "( (category==4 || category==1) && abs(var_MaxD0Significance)<100 && MC==0)";
	TCut mycuts = "category==1 && abs(var_MaxD0Significance)<100 && MC==1";
...
int main( int argc, char** argv )
{
   ...
   return TMVAReweighted_7(methodList);
}
