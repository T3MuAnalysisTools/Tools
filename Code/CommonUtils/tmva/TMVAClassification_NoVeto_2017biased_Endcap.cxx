...
int TMVAClassification_NoVeto_2017biased_Endcap( TString myMethodList = "" ){
...
TString outfileName = "TMVAClassification_NoVeto_2017biased_Endcap_Output.root";   // Output file
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   // Ds signal
   // ____________
TString factoryName = "TMVAClassification_NoVeto_2017biased_Endcap";   TMVA::Factory *factory = new TMVA::Factory( factoryName, outputFile,
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_NoVeto_2017biased_Endcap(methodList);
}
