...
int Run2017Classification_6( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_6.root";   // output file
...
TString factoryName = "Run2017Classification_6";   
...
dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
"nTrain_Signal=4341:nTrain_Background=9276:SplitMode=Random:NormMode=NumEvents:!V");
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_6(methodList);
}
