...
int Run2017Classification_biased_C( TString myMethodList = "" )
{
...
TString outfileName = "TMVATrees_Run2017_MC_Output_biased_C.root";   // output file
...
TString factoryName = "Run2017Classification_biased_C";   
...
TCut mycutb = "( (category==6 || category==3) && MC==0 && var_MaxD0Significance<100 && var_MaxD0Significance>=0 )";
TCut mycuts = "category==3 && MC==1";
...
dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
"nTrain_Signal=4341:nTrain_Background=3489:SplitMode=Random:NormMode=NumEvents:!V");
...
int main( int argc, char** argv )
{
   ...
   return Run2017Classification_biased_C(methodList);
}
