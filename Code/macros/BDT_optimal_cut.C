...
void BDT_optimal_cut() 
{
  /*  //pull path of root files generated by TMVA
    TString file_name[2] = {"TMVATrees_Run2017_MC_Output_unbiased_Barrel.root",
                            "TMVATrees_Run2017_MC_Output_unbiased_Endcap.root"};
    //                            "TMVATrees_Run2017_MC_Output_unbiased_C.root"};
    TString cat_name[2] = {"catBarrel",
                           "catEndcap"};
    //                           "catC"};
    */
    ...
    //pull path of root files generated by TMVA
  TString file_name[3] = {"TMVATrees_Run2017_reweightedMC_Output_7.root",
			  "TMVATrees_Run2017_reweightedMC_Output_8.root",
			  "TMVATrees_Run2017_reweightedMC_Output_9.root"};
  TString cat_name[3] = {"catA",
    ...
    Double_t sig_norm = 0.00014; //average normalization factor for the three signal samples
    ...
    for(int k=0; k<3; k++)
    {
	    ...
	    TH1F *h_test_signal;
	    TH1F *h_test_bkg;
	    h_test_signal = (TH1F*)f->Get("datasets/Method_BDT/BDT/MVA_BDT_S");
	    h_test_bkg = (TH1F*)f->Get("datasets/Method_BDT/BDT/MVA_BDT_B");
	    ...
	    TH1F *h_test_signal2;
	    TH1F *h_test_bkg2;
	    h_test_signal2 = (TH1F*)f2->Get("datasets/Method_BDT/BDT/MVA_BDT_S");
	    h_test_bkg2 = (TH1F*)f2->Get("datasets/Method_BDT/BDT/MVA_BDT_B");
