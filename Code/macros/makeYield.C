...
void makeYield () 
{
    ...
    InvMass1.setRange("R3",1.65,1.9); //signal
    ...
    RooRealVar mean1("mean1", "mean1", 1.0,0.,5.);
    RooRealVar sigma1("sigma1", "sigma1", 0.5,0.001,10);
    RooRealVar GaussNorm1("GaussNorm1", "GaussNorm1", 50.0,0.01,150);
    ...
    InvMass2.setRange("R3",1.65,1.9); //signal
    ...
    RooRealVar mean2("mean2", "mean2", 1.0,0.,5.);
    RooRealVar sigma2("sigma2", "sigma2", 0.5,0.001,10);
    RooRealVar GaussNorm2("GaussNorm2", "GaussNorm2", 50.0,0.01,150);
    ...
    InvMass3.setRange("R3",1.65,1.9); //signal
    ...
    RooRealVar mean3("mean3", "mean3", 1.0,0.,5.);
    RooRealVar sigma3("sigma3", "sigma3", 0.5,0.001,10);
    RooRealVar GaussNorm3("GaussNorm3", "GaussNorm3", 50.0,0.01,150);
