...
void BDT_optimal_cut3() 
{

    //pull path of root files generated by TMVA
    TString file_name[3] = {"TMVATrees_Run2017_reweightedMC_2017biased_Output_A.root",
                            "TMVATrees_Run2017_reweightedMC_2017biased_Output_B.root",
                            "TMVATrees_Run2017_reweightedMC_2017biased_Output_C.root"};



    //TMVATrees_Run2017_reweightedMC_Output_7.root
    ...
    for(int k=0; k<3; k++)
    {
	    ...
	    h_test_signal = (TH1F*)f->Get("datasets/Method_BDT/BDT/MVA_BDT_S_high");
	    h_test_bkg = (TH1F*)f->Get("datasets/Method_BDT/BDT/MVA_BDT_B_high");
