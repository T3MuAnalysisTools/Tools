...
TMVA_Signal_trkMuon::TMVA_Signal_trkMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Signal_trkMuon::~TMVA_Signal_trkMuon(){
...
void  TMVA_Signal_trkMuon::Configure(){
...
void  TMVA_Signal_trkMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Signal_trkMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Signal_trkMuon::Finish(){
file= new TFile("TMVA_Signal_trkMuonInput.root","recreate");
