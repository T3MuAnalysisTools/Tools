#include "TMVA_Tree_1_looseMuon.h"
...
TMVA_Tree_1_looseMuon::TMVA_Tree_1_looseMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_1_looseMuon::~TMVA_Tree_1_looseMuon(){
...
void  TMVA_Tree_1_looseMuon::Configure(){
...
void  TMVA_Tree_1_looseMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_1_looseMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_1_looseMuon::Finish(){
file= new TFile("TMVA_Tree_1_looseMuonInput.root","recreate");
