#ifndef TMVA_Tree_2_softMuon_h
#define TMVA_Tree_2_softMuon_h

#include "Selection.h"
#include <vector>
#include "TString.h"

class TMVA_Tree_2_softMuon : public Selection {

 public:
  TMVA_Tree_2_softMuon(TString Name_, TString id_);
  virtual ~TMVA_Tree_2_softMuon();
