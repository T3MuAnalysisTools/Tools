#include "TMVA_Tree_2_softMuon.h"
...
TMVA_Tree_2_softMuon::TMVA_Tree_2_softMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_2_softMuon::~TMVA_Tree_2_softMuon(){
...
void  TMVA_Tree_2_softMuon::Configure(){
...
void  TMVA_Tree_2_softMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_2_softMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_2_softMuon::Finish(){
file= new TFile("TMVA_Tree_2_softMuonInput.root","recreate");
