...
void  ThreeMu::Configure(){
  ...
  for(int i=0; i<NCuts;i++){
    ...
    if(i==ThreeMuCandidate)    cut.at(ThreeMuCandidate)=1;
	 if(i==IsMedPrompt)			 cut.at(IsMedPrompt)=1;
	 if(i==PhiVeto)			 	 cut.at(PhiVeto)=0; 
	 if(i==OmegaVeto)		 		 cut.at(OmegaVeto)=0;
  ...
  VertexSignalKFRefittedMu1P=HConfig.GetTH1D(Name+"_VertexSignalKFRefittedMu1P","VertexSignalKFRefittedMu1P",100,0,20,"KF refitted #mu_{1} track p (GeV)","Events");
  VertexSignalKFRefittedMu1Pt=HConfig.GetTH1D(Name+"_VertexSignalKFRefittedMu1Pt","VertexSignalKFRefittedMu1P",100,0,20,"KF refitted #mu_{1} track p_{T} (GeV)","Events");
  ...
  VertexSignalKFRefittedMu2P=HConfig.GetTH1D(Name+"_VertexSignalKFRefittedMu2P","VertexSignalKFRefittedMu2P",100,0,20,"KF refitted #mu_{2} track p (GeV)","Events");
  VertexSignalKFRefittedMu2Pt=HConfig.GetTH1D(Name+"_VertexSignalKFRefittedMu2Pt","VertexSignalKFRefittedMu2Pt",100,0,20,"KF refitted #mu_{2} track p_{T} (GeV)","Events");
  ...
  VertexSignalKFRefittedMu3P=HConfig.GetTH1D(Name+"_VertexSignalKFRefittedMu3P","VertexSignalKFRefittedMu3P",100,0,20,"KF refitted Mu3 p (GeV)","Events");
  VertexSignalKFRefittedMu3Pt=HConfig.GetTH1D(Name+"_VertexSignalKFRefittedMu3Pt","VertexSignalKFRefittedMu3Pt",100,0,20,"KF refitted Mu3 p_{T} (GeV)","Events");
  ...
  VertexMu1D0Reco=HConfig.GetTH1D(Name+"_VertexMu1D0Reco","VertexMu1D0Reco",100,0,0.5,"#mu_{1} d0 vertex","Events");
  VertexMu1D0SigReco=HConfig.GetTH1D(Name+"_VertexMu1D0SigReco","VertexMu1D0SigReco",100,0,0.5,"#mu_{1} d0 vertex significance","Events");
  VertexMu2D0Reco=HConfig.GetTH1D(Name+"_VertexMu2D0Reco","VertexMu2D0Reco",100,0,0.5,"#mu_{2} d0 vertex","Events");
  VertexMu2D0SigReco=HConfig.GetTH1D(Name+"_VertexMu2D0SigReco","VertexMu2D0SigReco",100,0,0.5,"#mu_{2} d0 vertex significance","Events");
  VertexMu3D0Reco=HConfig.GetTH1D(Name+"_VertexMu3D0Reco","VertexMu3D0Reco",100,0,0.5,"track d0 vertex","Events");
  VertexMu3D0SigReco=HConfig.GetTH1D(Name+"_VertexMu3D0SigReco","VertexMu3D0SigReco",100,0,0.5,"track d0 vertex significance","Events");
  ...
  VertexMatchedPrimaryVertexX=HConfig.GetTH1D(Name+"_VertexMatchedPrimaryVertexX","VertexMatchedPrimaryVertexX",100,0,0.15,"vertex matched pv x (cm)","Events");
  VertexMatchedPrimaryVertexY=HConfig.GetTH1D(Name+"_VertexMatchedPrimaryVertexY","VertexMatchedPrimaryVertexY",100,0,0.15,"vertex matched pv y (cm)","Events");
  VertexMatchedPrimaryVertexZ=HConfig.GetTH1D(Name+"_VertexMatchedPrimaryVertexZ","VertexMatchedPrimaryVertexZ",100,0,0.15,"vertex matched pv z (cm)","Events");
...
void  ThreeMu::doEvent(){ 
  ...
  for (unsigned int cidx=0; cidx<Ntp->NThreeMuons(); cidx++){
  	...
  	unsigned int mu2_idx = Ntp->ThreeMuonIndices(cidx).at(1); 
  	unsigned int mu3_idx = Ntp->ThreeMuonIndices(cidx).at(2);

   if( !(Ntp->MuonStandardSelectorBitMask(mu1_idx).at(2) && 
 ...
 if (final_idx!=-1){
	 ...
	 double tau_mass = (Ntp->Muon_P4(mu1_idx)+Ntp->Muon_P4(mu2_idx)+Ntp->Muon_P4(mu3_idx)).M();
    ...
    value.at(PhiVeto) =  M_dimu_phi;
    value.at(OmegaVeto) = M_dimu_omega;

    float mu1_trgObj_dR = Ntp->ThreeMuons_TriggerMatch_dR(final_idx).at(0);
    float mu2_trgObj_dR = Ntp->ThreeMuons_TriggerMatch_dR(final_idx).at(1);
    float mu3_trgObj_dR = Ntp->ThreeMuons_TriggerMatch_dR(final_idx).at(2);
