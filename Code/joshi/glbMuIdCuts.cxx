...
glbMuIdCuts::glbMuIdCuts(TString Name_, TString id_):
  Selection(Name_,id_),
  tauMinMass_(1.731),
  tauMaxMass_(1.823),
  tauMinSideBand_(1.6),
...
void  glbMuIdCuts::Store_ExtraDist(){ 
