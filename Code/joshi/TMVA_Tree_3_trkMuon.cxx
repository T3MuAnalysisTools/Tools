...
TMVA_Tree_3_trkMuon::TMVA_Tree_3_trkMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_3_trkMuon::~TMVA_Tree_3_trkMuon(){
...
void  TMVA_Tree_3_trkMuon::Configure(){
...
void  TMVA_Tree_3_trkMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_3_trkMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_3_trkMuon::Finish(){
file= new TFile("TMVA_Tree_3_trkMuonInput.root","recreate");
