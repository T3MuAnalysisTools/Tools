#ifndef TMVA_Signal_softMuon_h
#define TMVA_Signal_softMuon_h

#include "Selection.h"
#include <vector>
#include "TString.h"

class TMVA_Signal_softMuon : public Selection {

 public:
  TMVA_Signal_softMuon(TString Name_, TString id_);
  virtual ~TMVA_Signal_softMuon();
