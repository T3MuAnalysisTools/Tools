#include "TMVA_Tree_2_looseMuon.h"
...
TMVA_Tree_2_looseMuon::TMVA_Tree_2_looseMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_2_looseMuon::~TMVA_Tree_2_looseMuon(){
...
void  TMVA_Tree_2_looseMuon::Configure(){
...
void  TMVA_Tree_2_looseMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_2_looseMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_2_looseMuon::Finish(){
file= new TFile("TMVA_Tree_2_looseMuonInput.root","recreate");
