#include "TMVA_Signal_softMuon.h"
...
TMVA_Signal_softMuon::TMVA_Signal_softMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Signal_softMuon::~TMVA_Signal_softMuon(){
...
void  TMVA_Signal_softMuon::Configure(){
...
void  TMVA_Signal_softMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Signal_softMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Signal_softMuon::Finish(){
file= new TFile("TMVA_Signal_softMuonInput.root","recreate");
