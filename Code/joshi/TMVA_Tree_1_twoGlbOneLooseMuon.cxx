#include "TMVA_Tree_1_twoGlbOneLooseMuon.h"
...
TMVA_Tree_1_twoGlbOneLooseMuon::TMVA_Tree_1_twoGlbOneLooseMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_1_twoGlbOneLooseMuon::~TMVA_Tree_1_twoGlbOneLooseMuon(){
...
void  TMVA_Tree_1_twoGlbOneLooseMuon::Configure(){
...
void  TMVA_Tree_1_twoGlbOneLooseMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_1_twoGlbOneLooseMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_1_twoGlbOneLooseMuon::Finish(){
file= new TFile("TMVA_Tree_1_twoGlbOneLooseMuonInput.root","recreate");
