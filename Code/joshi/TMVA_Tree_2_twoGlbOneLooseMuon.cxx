#include "TMVA_Tree_2_twoGlbOneLooseMuon.h"
...
TMVA_Tree_2_twoGlbOneLooseMuon::TMVA_Tree_2_twoGlbOneLooseMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_2_twoGlbOneLooseMuon::~TMVA_Tree_2_twoGlbOneLooseMuon(){
...
void  TMVA_Tree_2_twoGlbOneLooseMuon::Configure(){
    ...
    //----------------------------------------------
    //   2016 TMVA variables (muMinPt replaced with flight length significance)
    //----------------------------------------------
		TMVA_Tree->Branch("var_KFV_chiSq", &var_KFV_chiSq);
  		TMVA_Tree->Branch("var_flightLenSig", &var_flightLenSig) ; // Add flight length significance
...
void  TMVA_Tree_2_twoGlbOneLooseMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_2_twoGlbOneLooseMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_2_twoGlbOneLooseMuon::Finish(){
file= new TFile("TMVA_Tree_2_twoGlbOneLooseMuonInput.root","recreate");
