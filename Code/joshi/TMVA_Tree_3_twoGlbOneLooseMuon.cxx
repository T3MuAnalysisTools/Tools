#include "TMVA_Tree_3_twoGlbOneLooseMuon.h"
...
TMVA_Tree_3_twoGlbOneLooseMuon::TMVA_Tree_3_twoGlbOneLooseMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_3_twoGlbOneLooseMuon::~TMVA_Tree_3_twoGlbOneLooseMuon(){
...
void  TMVA_Tree_3_twoGlbOneLooseMuon::Configure(){
...
void  TMVA_Tree_3_twoGlbOneLooseMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_3_twoGlbOneLooseMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_3_twoGlbOneLooseMuon::Finish(){
file= new TFile("TMVA_Tree_3_twoGlbOneLooseMuonInput.root","recreate");
