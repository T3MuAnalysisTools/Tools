#include "TMVA_Tree_1_softMuon.h"
...
TMVA_Tree_1_softMuon::TMVA_Tree_1_softMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_1_softMuon::~TMVA_Tree_1_softMuon(){
...
void  TMVA_Tree_1_softMuon::Configure(){
...
void  TMVA_Tree_1_softMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_1_softMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_1_softMuon::Finish(){
file= new TFile("TMVA_Tree_1_softMuonInput.root","recreate");
