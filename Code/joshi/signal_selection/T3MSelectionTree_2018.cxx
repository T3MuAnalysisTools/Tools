   ...
   omegaVetoSigma(0.017)
{
   ...
   file= new TFile("T3MSelectionTreeInput.root","recreate");
}
...
void  T3MSelectionTree::Configure(){
   ...
   TMVA_Tree->Branch("var_KMuTrkInvMassOS2Pair1", &var_KMuKTrkInvMassOS2Pair1);
   ...
   TMVA_Tree->Branch("var_InvMassConeIso0p3", &var_InvMassConeIso0p3);
   TMVA_Tree->Branch("var_InvMassConeIso0p5", &var_InvMassConeIso0p5);
   TMVA_Tree->Branch("var_InvMassConeIso0p8", &var_InvMassConeIso0p8);
   TMVA_Tree->Branch("var_InvMassConeIso1p2", &var_InvMassConeIso1p2);
   TMVA_Tree->Branch("var_InvMassConeIso1p4", &var_InvMassConeIso1p4);
   ...
   //TMVA_Tree->Branch("mu2_trk_InvMass", &mu2_trk_InvMass);
   //TMVA_Tree->Branch("mu1_trk_InvMass", &mu1_trk_InvMass);
...
void  T3MSelectionTree::doEvent(){ 
   ...
   if(status){
      ...
      if (closest_track_index!=-1){
         TLorentzVector tmp_trk_p4 = TLorentzVector(Ntp->IsolationTrack_p4(final_idx, closest_track_index, false).Px(),
               Ntp->IsolationTrack_p4(final_idx, closest_track_index, false).Py(),
               Ntp->IsolationTrack_p4(final_idx, closest_track_index, false).Pz(),
               sqrt(pow(Ntp->IsolationTrack_p4(final_idx, closest_track_index, false).P(), 2)+
                  pow(PDG_Var::Kp_mass(),2)));


         TLorentzVector tmp_mu3_p4 = TLorentzVector(Ntp->Muon_P4(Muon_index_3).Px(),
               Ntp->Muon_P4(Muon_index_3).Py(),
               Ntp->Muon_P4(Muon_index_3).Pz(),
               sqrt(pow(Ntp->Muon_P4(Muon_index_3).P(),2)+pow(PDG_Var::Kp_mass(),2)));

         mu3_trk_InvMass = (tmp_trk_p4+tmp_mu3_p4).M();
      }
      ...
      if (mutrk_chi31<=mutrk_chi32){
         if (mutrk_chi31<30) {
            var_PiMuTrkInvMassOS1Pair1 = (Ntp->MuonToPion(Muon_index_3)+Ntp->Track_P4(mutrk_trk31_idx)).M();
            var_PiMuKTrkInvMassOS1Pair1 = (Ntp->MuonToPion(Muon_index_3)+Ntp->KaonTrack_P4(mutrk_trk31_idx)).M();
            var_KMuTrkInvMassOS1Pair1 = (Ntp->MuonToKaon(Muon_index_3)+Ntp->Track_P4(mutrk_trk31_idx)).M();
            var_KMuKTrkInvMassOS1Pair1 = (Ntp->MuonToKaon(Muon_index_3)+Ntp->KaonTrack_P4(mutrk_trk31_idx)).M();
            var_MuTrkOS1Pair1dR = Ntp->Muon_innerTrack_p4(Muon_index_3).DeltaR(Ntp->Track_P4(mutrk_trk31_idx));
         }
         if (mutrk_chi32<30) {
            var_PiMuTrkInvMassOS2Pair1 = (Ntp->MuonToPion(Muon_index_3)+Ntp->Track_P4(mutrk_trk32_idx)).M();
            var_PiMuKTrkInvMassOS2Pair1 = (Ntp->MuonToPion(Muon_index_3)+Ntp->KaonTrack_P4(mutrk_trk32_idx)).M();
            var_KMuTrkInvMassOS2Pair1 = (Ntp->MuonToKaon(Muon_index_3)+Ntp->Track_P4(mutrk_trk32_idx)).M();
            var_KMuKTrkInvMassOS2Pair1 = (Ntp->MuonToKaon(Muon_index_3)+Ntp->KaonTrack_P4(mutrk_trk32_idx)).M();
            var_MuTrkOS2Pair1dR = Ntp->Muon_innerTrack_p4(Muon_index_3).DeltaR(Ntp->Track_P4(mutrk_trk32_idx));
         }
      } else {
         if (mutrk_chi32<30) {
            var_PiMuTrkInvMassOS1Pair1 = (Ntp->MuonToPion(Muon_index_3)+Ntp->Track_P4(mutrk_trk32_idx)).M();
            var_PiMuKTrkInvMassOS1Pair1 = (Ntp->MuonToPion(Muon_index_3)+Ntp->KaonTrack_P4(mutrk_trk32_idx)).M();
            var_KMuTrkInvMassOS1Pair1 = (Ntp->MuonToKaon(Muon_index_3)+Ntp->Track_P4(mutrk_trk32_idx)).M();
            var_KMuKTrkInvMassOS1Pair1 = (Ntp->MuonToKaon(Muon_index_3)+Ntp->KaonTrack_P4(mutrk_trk32_idx)).M();
            var_MuTrkOS1Pair1dR = Ntp->Muon_innerTrack_p4(Muon_index_3).DeltaR(Ntp->Track_P4(mutrk_trk32_idx));
         }
         if (mutrk_chi31<30) {
            var_PiMuTrkInvMassOS2Pair1 = (Ntp->MuonToPion(Muon_index_3)+Ntp->Track_P4(mutrk_trk31_idx)).M();
            var_PiMuKTrkInvMassOS2Pair1 = (Ntp->MuonToPion(Muon_index_3)+Ntp->KaonTrack_P4(mutrk_trk31_idx)).M();
            var_KMuTrkInvMassOS2Pair1 = (Ntp->MuonToKaon(Muon_index_3)+Ntp->Track_P4(mutrk_trk31_idx)).M();
            var_KMuKTrkInvMassOS2Pair1 = (Ntp->MuonToKaon(Muon_index_3)+Ntp->KaonTrack_P4(mutrk_trk31_idx)).M();
            var_MuTrkOS2Pair1dR = Ntp->Muon_innerTrack_p4(Muon_index_3).DeltaR(Ntp->Track_P4(mutrk_trk31_idx));
         }
      }
      ...
      if (mutrk_chi12<=mutrk_chi13){
         if (mutrk_chi12<30) {
            var_PiMuTrkInvMassOS1Pair2 = (Ntp->MuonToPion(Muon_index_1)+Ntp->Track_P4(mutrk_trk12_idx)).M();
            var_PiMuKTrkInvMassOS2Pair2 = (Ntp->MuonToPion(Muon_index_1)+Ntp->KaonTrack_P4(mutrk_trk12_idx)).M();
            var_KMuTrkInvMassOS2Pair2 = (Ntp->MuonToKaon(Muon_index_1)+Ntp->Track_P4(mutrk_trk12_idx)).M();
            var_KMuKTrkInvMassOS1Pair2 = (Ntp->MuonToKaon(Muon_index_1)+Ntp->KaonTrack_P4(mutrk_trk12_idx)).M();
            var_MuTrkOS1Pair2dR = Ntp->Muon_innerTrack_p4(Muon_index_1).DeltaR(Ntp->Track_P4(mutrk_trk12_idx));
         }
         if (mutrk_chi13<30) {
            var_PiMuTrkInvMassOS2Pair2 = (Ntp->MuonToPion(Muon_index_1)+Ntp->Track_P4(mutrk_trk13_idx)).M();
            var_PiMuKTrkInvMassOS2Pair2 = (Ntp->MuonToPion(Muon_index_1)+Ntp->KaonTrack_P4(mutrk_trk13_idx)).M();
            var_KMuTrkInvMassOS2Pair2 = (Ntp->MuonToKaon(Muon_index_1)+Ntp->Track_P4(mutrk_trk13_idx)).M();
            var_KMuKTrkInvMassOS2Pair2 = (Ntp->MuonToKaon(Muon_index_1)+Ntp->KaonTrack_P4(mutrk_trk13_idx)).M();
            var_MuTrkOS2Pair2dR = Ntp->Muon_innerTrack_p4(Muon_index_1).DeltaR(Ntp->Track_P4(mutrk_trk13_idx));
         }
      } else {
         if (mutrk_chi13<30) {
            var_PiMuTrkInvMassOS1Pair2 = (Ntp->MuonToPion(Muon_index_1)+Ntp->Track_P4(mutrk_trk13_idx)).M();
            var_PiMuKTrkInvMassOS1Pair2 = (Ntp->MuonToPion(Muon_index_1)+Ntp->KaonTrack_P4(mutrk_trk13_idx)).M();
            var_KMuTrkInvMassOS1Pair2 = (Ntp->MuonToKaon(Muon_index_1)+Ntp->Track_P4(mutrk_trk13_idx)).M();
            var_KMuKTrkInvMassOS1Pair2 = (Ntp->MuonToKaon(Muon_index_1)+Ntp->KaonTrack_P4(mutrk_trk13_idx)).M();
            var_MuTrkOS1Pair2dR = Ntp->Muon_innerTrack_p4(Muon_index_1).DeltaR(Ntp->Track_P4(mutrk_trk13_idx));
         }
         if (mutrk_chi12<30) {
            var_PiMuTrkInvMassOS2Pair2 = (Ntp->MuonToPion(Muon_index_1)+Ntp->Track_P4(mutrk_trk12_idx)).M();
            var_PiMuKTrkInvMassOS2Pair2 = (Ntp->MuonToPion(Muon_index_1)+Ntp->KaonTrack_P4(mutrk_trk12_idx)).M();
            var_KMuTrkInvMassOS2Pair2 = (Ntp->MuonToKaon(Muon_index_1)+Ntp->Track_P4(mutrk_trk12_idx)).M();
            var_KMuKTrkInvMassOS2Pair2 = (Ntp->MuonToKaon(Muon_index_1)+Ntp->KaonTrack_P4(mutrk_trk12_idx)).M();
            var_MuTrkOS2Pair2dR = Ntp->Muon_innerTrack_p4(Muon_index_1).DeltaR(Ntp->Track_P4(mutrk_trk12_idx));
         }
      }
      ...
      if (mutrk_chi21<=mutrk_chi23){
         if (mutrk_chi21<30) {
            var_PiMuTrkInvMassOS1Pair3 = (Ntp->MuonToPion(Muon_index_2)+Ntp->Track_P4(mutrk_trk21_idx)).M();
            var_KMuTrkInvMassOS1Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->Track_P4(mutrk_trk21_idx)).M();
            var_KMuKTrkInvMassOS1Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->KaonTrack_P4(mutrk_trk21_idx)).M();
            var_KMuKTrkInvMassOS1Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->KaonTrack_P4(mutrk_trk21_idx)).M();
            var_MuTrkOS1Pair3dR = Ntp->Muon_innerTrack_p4(Muon_index_2).DeltaR(Ntp->Track_P4(mutrk_trk21_idx));
         }
         if (mutrk_chi23<30) {
            var_PiMuTrkInvMassOS2Pair3 = (Ntp->MuonToPion(Muon_index_2)+Ntp->Track_P4(mutrk_trk23_idx)).M();
            var_KMuTrkInvMassOS2Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->Track_P4(mutrk_trk23_idx)).M();
            var_KMuKTrkInvMassOS2Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->KaonTrack_P4(mutrk_trk23_idx)).M();
            var_KMuKTrkInvMassOS2Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->KaonTrack_P4(mutrk_trk23_idx)).M();
            var_MuTrkOS2Pair3dR = Ntp->Muon_innerTrack_p4(Muon_index_2).DeltaR(Ntp->Track_P4(mutrk_trk23_idx));
         }
      } else {
         if (mutrk_chi23<30) {
            var_PiMuTrkInvMassOS1Pair3 = (Ntp->MuonToPion(Muon_index_2)+Ntp->Track_P4(mutrk_trk23_idx)).M();
            var_KMuTrkInvMassOS1Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->Track_P4(mutrk_trk23_idx)).M();
            var_KMuKTrkInvMassOS1Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->KaonTrack_P4(mutrk_trk23_idx)).M();
            var_KMuKTrkInvMassOS1Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->KaonTrack_P4(mutrk_trk23_idx)).M();
            var_MuTrkOS1Pair3dR = Ntp->Muon_innerTrack_p4(Muon_index_2).DeltaR(Ntp->Track_P4(mutrk_trk23_idx));
         }
         if (mutrk_chi21<30) {
            var_PiMuTrkInvMassOS2Pair3 = (Ntp->MuonToPion(Muon_index_2)+Ntp->Track_P4(mutrk_trk21_idx)).M();
            var_KMuTrkInvMassOS2Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->Track_P4(mutrk_trk21_idx)).M();
            var_KMuKTrkInvMassOS2Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->KaonTrack_P4(mutrk_trk21_idx)).M();
            var_KMuKTrkInvMassOS2Pair3 = (Ntp->MuonToKaon(Muon_index_2)+Ntp->KaonTrack_P4(mutrk_trk21_idx)).M();
            var_MuTrkOS2Pair3dR = Ntp->Muon_innerTrack_p4(Muon_index_2).DeltaR(Ntp->Track_P4(mutrk_trk21_idx));
         }
      }
      ...
      float tauMassResRefitted = Ntp->TauMassResolution(EtaSortedIndices,1,true);
      ...
      Muon1_trkKink = log(Ntp->Muon_combinedQuality_trkKink(Muon_index_1)+0.01);
      Muon1_glbKink = log(Ntp->Muon_combinedQuality_glbKink(Muon_index_1)+0.01);
      ...
      Muon2_trkKink = log(Ntp->Muon_combinedQuality_trkKink(Muon_index_2)+0.01);
      Muon2_glbKink = log(Ntp->Muon_combinedQuality_glbKink(Muon_index_2)+0.01);
      ...
      Muon3_trkKink = log(Ntp->Muon_combinedQuality_trkKink(Muon_index_3)+0.01);
      Muon3_glbKink = log(Ntp->Muon_combinedQuality_glbKink(Muon_index_3)+0.01);
      ...
      for(int i =0; i< Ntp->NIsolationTrack(final_idx); i++){
         ...
         if(Ntp->IsolationTrack_p4(final_idx,i,false).Pt()> TrackPTthreshold && fabs(Ntp->IsolationTrack_dzPV(final_idx,i,false)) < 0.05 && 
      ...
      for(int i =0; i< Ntp->NIsolationTrack(final_idx,false); i++){
         ...
         if(Ntp->IsolationTrack_p4(final_idx,i,false).Pt()> TrackPTthreshold && fabs(Ntp->IsolationTrack_dzPV(final_idx,i,false)) < 0.05
            ...
            if(Ntp->Muon_charge(Muon_index_1)!=Ntp->IsolationTrack_charge(final_idx,i,false)){
      ...
      var_Iso02Mu1 = Muon1LV.Pt()/ (Muon1LV.Pt() + sumTracksIso02);
      var_Iso04Mu1 = Muon1LV.Pt()/ (Muon1LV.Pt() + sumTracksIso04);
      var_Iso06Mu1 = Muon1LV.Pt()/ (Muon1LV.Pt() + sumTracksIso06);
      var_Iso08Mu1 = Muon1LV.Pt()/ (Muon1LV.Pt() + sumTracksIso08);
      var_Iso1Mu1 = Muon1LV.Pt()/  (Muon1LV.Pt() + sumTracksIso1);
      var_Iso12Mu1 = Muon1LV.Pt()/ (Muon1LV.Pt() + sumTracksIso12);
      var_Iso14Mu1 = Muon1LV.Pt()/ (Muon1LV.Pt() + sumTracksIso14);
      var_Iso16Mu1 = Muon1LV.Pt()/ (Muon1LV.Pt() + sumTracksIso16);
      var_Iso18Mu1 = Muon1LV.Pt()/ (Muon1LV.Pt() + sumTracksIso18);
      var_Iso2Mu1 = Muon1LV.Pt()/ (Muon1LV.Pt() + sumTracksIso2);
      ...
      for(int i =0; i< Ntp->NIsolationTrack(final_idx,false); i++){
         ...
         if(Ntp->IsolationTrack_p4(final_idx,i,false).Pt()> TrackPTthreshold && fabs(Ntp->IsolationTrack_dzPV(final_idx,i,false)) < 0.05
            ...
            if(Ntp->Muon_charge(Muon_index_2)!=Ntp->IsolationTrack_charge(final_idx,i,false)){
      ...
      for(int i =0; i< Ntp->NIsolationTrack(final_idx,false); i++){
         ...
         if(Ntp->IsolationTrack_p4(final_idx,i,false).Pt()> TrackPTthreshold && fabs(Ntp->IsolationTrack_dzPV(final_idx,i,false)) < 0.05
            ...
            if(Ntp->Muon_charge(Muon_index_3)!=Ntp->IsolationTrack_charge(final_idx,i,false)){
      ...
      var_Iso02Mu3 = Muon3LV.Pt()/ (Muon3LV.Pt() + sumTracksIso02);
      var_Iso04Mu3 = Muon3LV.Pt()/ (Muon3LV.Pt() + sumTracksIso04);
      var_Iso06Mu3 = Muon3LV.Pt()/ (Muon3LV.Pt() + sumTracksIso06);
      var_Iso08Mu3 = Muon3LV.Pt()/ (Muon3LV.Pt() + sumTracksIso08);
      var_Iso1Mu3 = Muon3LV.Pt()/  (Muon3LV.Pt() + sumTracksIso1);
      var_Iso12Mu3 = Muon3LV.Pt()/ (Muon3LV.Pt() + sumTracksIso12);
      var_Iso14Mu3 = Muon3LV.Pt()/ (Muon3LV.Pt() + sumTracksIso14);
      var_Iso16Mu3 = Muon3LV.Pt()/ (Muon3LV.Pt() + sumTracksIso16);
      var_Iso18Mu3 = Muon3LV.Pt()/ (Muon3LV.Pt() + sumTracksIso18);
      var_Iso2Mu3 = Muon3LV.Pt()/ (Muon3LV.Pt() + sumTracksIso2);
      ...
      TLorentzVector sumTracksIso0p3 = TauLV;
      TLorentzVector sumTracksIso0p5 = TauLV;
      TLorentzVector sumTracksIso0p8 = TauLV;
      TLorentzVector sumTracksIso1p2 = TauLV;
      TLorentzVector sumTracksIso1p4 = TauLV;
      ...
      for (int it=0; it<Ntp->NIsolationTrack(final_idx); it++){
         ...
         if (TrackLV.DeltaR(TauLV)<0.3){
            sumTracksIso0p3 += TrackLV;
            nTracksIso0p3 += 1;
         }
         if (TrackLV.DeltaR(TauLV)<0.5){
            sumTracksIso0p5 += TrackLV;
            nTracksIso0p5 += 1;
         }
         if (TrackLV.DeltaR(TauLV)<0.8){
            sumTracksIso0p8 += TrackLV;
            nTracksIso0p8 += 1;
         }
         if (TrackLV.DeltaR(TauLV)<1.2){
            sumTracksIso1p2 += TrackLV;
            nTracksIso1p2 += 1;
         }
         if (TrackLV.DeltaR(TauLV)<1.4){
