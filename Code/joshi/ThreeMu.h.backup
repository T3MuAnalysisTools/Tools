...
class ThreeMu : public Selection {
 ...
 private:
  ...
  std::vector<TH1D> VertexSignalKFRefittedTrackP;
  std::vector<TH1D> VertexSignalKFRefittedTrackPt;
  std::vector<TH1D> VertexSignalKFRefittedTrackEta;
  std::vector<TH1D> VertexSignalKFRefittedTrackPhi;
  ...
  std::vector<TH1D> VertexTrackD0Reco;
  std::vector<TH1D> VertexTrackD0SigReco;
