#ifndef TMVA_Tree_2_glbMuon_h
#define TMVA_Tree_2_glbMuon_h

#include "Selection.h"
#include <vector>
#include "TString.h"

class TMVA_Tree_2_glbMuon : public Selection {

 public:
  TMVA_Tree_2_glbMuon(TString Name_, TString id_);
  virtual ~TMVA_Tree_2_glbMuon();
