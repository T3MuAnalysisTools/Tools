#include "twoGlbOneLooseMuIdCuts.h"
...
twoGlbOneLooseMuIdCuts::twoGlbOneLooseMuIdCuts(TString Name_, TString id_):
  Selection(Name_,id_),
  tauMinMass_(1.731),
  tauMaxMass_(1.823),
  tauMinSideBand_(1.6),
...
twoGlbOneLooseMuIdCuts::~twoGlbOneLooseMuIdCuts(){
...
void  twoGlbOneLooseMuIdCuts::Configure(){
...
void  twoGlbOneLooseMuIdCuts::Store_ExtraDist(){ 
...
void  twoGlbOneLooseMuIdCuts::doEvent(){ 
  unsigned int t;
  int id(Ntp->GetMCID());
...
void  twoGlbOneLooseMuIdCuts::Finish(){
