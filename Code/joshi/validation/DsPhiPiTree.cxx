...
void  DsPhiPiTree::Configure(){
   ...
   DsPhiPi_Tree->Branch("Muon3_InnerNC2", &Track_InnerNC2);
...
void  DsPhiPiTree::doEvent(){
   ...
   if (Ntp->NTwoMuonsTrack()>0){
      for (size_t j=0; j<Ntp->NTwoMuonsTrack(); ++j){
         ...
         value.at(MuonID) = ( Ntp->Muon_isGlobalMuon(Mu1_pt_idx) && Ntp->Muon_isPFMuon(Mu2_pt_idx) &&
                              Ntp->Muon_isGlobalMuon(Mu1_pt_idx) && !Ntp->Muon_isGlobalMuon(Mu2_pt_idx) && Ntp->Muon_isTrackerMuon(Mu2_pt_idx) );
        /*
