#ifndef TMVA_Signal_looseMuon_h
#define TMVA_Signal_looseMuon_h

#include "Selection.h"
#include <vector>
#include "TString.h"

class TMVA_Signal_looseMuon : public Selection {

 public:
  TMVA_Signal_looseMuon(TString Name_, TString id_);
  virtual ~TMVA_Signal_looseMuon();
