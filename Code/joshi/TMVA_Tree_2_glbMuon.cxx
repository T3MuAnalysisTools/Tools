...
TMVA_Tree_2_glbMuon::TMVA_Tree_2_glbMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_2_glbMuon::~TMVA_Tree_2_glbMuon(){
...
void  TMVA_Tree_2_glbMuon::Configure(){
...
void  TMVA_Tree_2_glbMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_2_glbMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_2_glbMuon::Finish(){
file= new TFile("TMVA_Tree_2_glbMuonInput.root","recreate");
