...
reader = new TMVA::Reader( "!Color:!Silent" );
  ...
  /*
  //-----------------------------------------------
   reader->AddVariable( "var_mu1kink",&var_mu1kink);
   reader->AddVariable( "var_mu2kink",&var_mu2kink);
   reader->AddVariable( "var_mu3kink",&var_mu3kink);
   reader->AddVariable( "var_IsoNtrk0p1",&var_IsoNtrk0p1);
   reader->AddVariable( "var_IsoNtrks",&var_IsoNtrks);
   reader->AddVariable( "var_IsoMaxDxy",&var_IsoMaxDxy);
   reader->AddVariable( "var_dRMu3Tau",&var_dRMu3Tau);
   //reader->AddVariable( "var_dRMu2Mu3",&var_dRMu2Mu3);
   reader->AddVariable( "var_Mmu1mu2",&var_Mmu1mu2);
  ...
  //			2016 TMVA variables
  //----------------------------------------------
	reader->AddVariable("var_muMinPt",&var_muMinPt);
	reader->AddVariable("var_inOutTrackMatch_Chi2",&var_inOutTrackMatch_Chi2);
	reader->AddVariable("var_mu3kink",&var_mu3kink);
	reader->AddVariable("var_vertexKFChi2",&var_vertexKFChi2);
	reader->AddVariable("var_VertexMu3D0Sig",&var_VertexMu3D0Sig);
	reader->AddVariable("var_VertexMu3D0",&var_VertexMu3D0);
