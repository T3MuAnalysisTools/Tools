#include "TMVA_Tree_3_softMuon.h"
...
TMVA_Tree_3_softMuon::TMVA_Tree_3_softMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_3_softMuon::~TMVA_Tree_3_softMuon(){
...
void  TMVA_Tree_3_softMuon::Configure(){
...
void  TMVA_Tree_3_softMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_3_softMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_3_softMuon::Finish(){
file= new TFile("TMVA_Tree_3_softMuonInput.root","recreate");
