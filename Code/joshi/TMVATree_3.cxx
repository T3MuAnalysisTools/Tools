...
TMVATree_3::TMVATree_3(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
void  TMVATree_3::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVATree_3::Finish(){
    file= new TFile("TMVATree3Input.root","recreate");
