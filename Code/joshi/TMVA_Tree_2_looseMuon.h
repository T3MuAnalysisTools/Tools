#ifndef TMVA_Tree_2_looseMuon_h
#define TMVA_Tree_2_looseMuon_h

#include "Selection.h"
#include <vector>
#include "TString.h"

class TMVA_Tree_2_looseMuon : public Selection {

 public:
  TMVA_Tree_2_looseMuon(TString Name_, TString id_);
  virtual ~TMVA_Tree_2_looseMuon();
