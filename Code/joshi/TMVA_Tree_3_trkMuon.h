#ifndef TMVA_Tree_3_trkMuon_h
#define TMVA_Tree_3_trkMuon_h

#include "Selection.h"
#include <vector>
#include "TString.h"

class TMVA_Tree_3_trkMuon : public Selection {

 public:
  TMVA_Tree_3_trkMuon(TString Name_, TString id_);
  virtual ~TMVA_Tree_3_trkMuon();
