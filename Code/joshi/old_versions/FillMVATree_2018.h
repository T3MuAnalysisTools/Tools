...
class FillMVATree : public Selection {
 ...
 public:
  ...
  enum cuts {TriggerOk=0,SignalCandidate, Mu1PtCut, Mu2PtCut, Mu3PtCut, MuonID, PhiVeto, OmegaVeto, TriggerMatchMu1, TriggerMatchMu2, TriggerMatchMu3, TauMassCut, GenMatch, NCuts};
