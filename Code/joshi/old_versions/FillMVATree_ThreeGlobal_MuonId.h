#ifndef FillMVATree_ThreeGlobal_MuonId_h
#define FillMVATree_ThreeGlobal_MuonId_h
...
class FillMVATree_ThreeGlobal_MuonId : public Selection {

   public:
      FillMVATree_ThreeGlobal_MuonId(TString Name_, TString id_);
      virtual ~FillMVATree_ThreeGlobal_MuonId();
