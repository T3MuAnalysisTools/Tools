#ifndef TMVA_Signal_twoGlbOneLooseMuon_h
#define TMVA_Signal_twoGlbOneLooseMuon_h

#include "Selection.h"
#include <vector>
#include "TString.h"

class TMVA_Signal_twoGlbOneLooseMuon : public Selection {

 public:
  TMVA_Signal_twoGlbOneLooseMuon(TString Name_, TString id_);
  virtual ~TMVA_Signal_twoGlbOneLooseMuon();
