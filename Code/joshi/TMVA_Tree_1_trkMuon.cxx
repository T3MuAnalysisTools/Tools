...
TMVA_Tree_1_trkMuon::TMVA_Tree_1_trkMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Tree_1_trkMuon::~TMVA_Tree_1_trkMuon(){
...
void  TMVA_Tree_1_trkMuon::Configure(){
...
void  TMVA_Tree_1_trkMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Tree_1_trkMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Tree_1_trkMuon::Finish(){
file= new TFile("TMVA_Tree_1_trkMuonInput.root","recreate");
