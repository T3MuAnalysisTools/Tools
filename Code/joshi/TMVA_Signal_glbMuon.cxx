...
TMVA_Signal_glbMuon::TMVA_Signal_glbMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Signal_glbMuon::~TMVA_Signal_glbMuon(){
...
void  TMVA_Signal_glbMuon::Configure(){
...
void  TMVA_Signal_glbMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Signal_glbMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Signal_glbMuon::Finish(){
file= new TFile("TMVA_Signal_glbMuonInput.root","recreate");
