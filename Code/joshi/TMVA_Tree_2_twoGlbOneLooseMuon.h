#ifndef TMVA_Tree_2_twoGlbOneLooseMuon_h
#define TMVA_Tree_2_twoGlbOneLooseMuon_h

#include "Selection.h"
#include <vector>
#include "TString.h"

class TMVA_Tree_2_twoGlbOneLooseMuon : public Selection {

 public:
  TMVA_Tree_2_twoGlbOneLooseMuon(TString Name_, TString id_);
  virtual ~TMVA_Tree_2_twoGlbOneLooseMuon();
