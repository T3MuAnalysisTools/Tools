#ifndef twoGlbOneLooseMuIdCuts_h
#define twoGlbOneLooseMuIdCuts_h

#include "Selection.h"
#include <vector>
#include "TString.h"

class twoGlbOneLooseMuIdCuts : public Selection {

 public:
  twoGlbOneLooseMuIdCuts(TString Name_, TString id_);
  virtual ~twoGlbOneLooseMuIdCuts();
