...
TMVATree_1::TMVATree_1(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
void  TMVATree_1::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVATree_1::Finish(){
    file= new TFile("TMVATree1Input.root","recreate");
