#include "TMVA_Signal_twoGlbOneLooseMuon.h"
...
TMVA_Signal_twoGlbOneLooseMuon::TMVA_Signal_twoGlbOneLooseMuon(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
    tauMinSideBand_(1.6),
...
TMVA_Signal_twoGlbOneLooseMuon::~TMVA_Signal_twoGlbOneLooseMuon(){
...
void  TMVA_Signal_twoGlbOneLooseMuon::Configure(){
...
void  TMVA_Signal_twoGlbOneLooseMuon::Store_ExtraDist(){ 
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
void  TMVA_Signal_twoGlbOneLooseMuon::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
...
void  TMVA_Signal_twoGlbOneLooseMuon::Finish(){
file= new TFile("TMVA_Signal_twoGlbOneLooseMuonInput.root","recreate");
