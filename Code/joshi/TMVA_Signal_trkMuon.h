#ifndef TMVA_Signal_trkMuon_h
#define TMVA_Signal_trkMuon_h

#include "Selection.h"
#include <vector>
#include "TString.h"

class TMVA_Signal_trkMuon : public Selection {

 public:
  TMVA_Signal_trkMuon(TString Name_, TString id_);
  virtual ~TMVA_Signal_trkMuon();
