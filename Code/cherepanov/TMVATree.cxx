...
TMVATree::TMVATree(TString Name_, TString id_):
  Selection(Name_,id_)
{
...
void  TMVATree::Configure(){

  TMVA_Tree= new TTree("tree","tree");
  TMVA_Tree->Branch("var1",&var1);
  TMVA_Tree->Branch("var2",&var2);
