...
void  BackgroundSelector::Configure(){
  ...
  MuPairsMass=HConfig.GetTH2D(Name+"_MuPairsMass","MuPairsMass",20,0.2,1.7,20,0.2,1.7,"m_{12}, GeV","m_{23}, GeV");
...
void  BackgroundSelector::Store_ExtraDist(){ 
  ...
  Extradist2d.push_back(&MuPairsMass);
...
void  BackgroundSelector::doEvent(){ 
  ...
  if(status){
    ...
    MuPairsMass.at(t).Fill( (MuonOS + MuonSS1).M(), (MuonOS + MuonSS2).M(),1   );
