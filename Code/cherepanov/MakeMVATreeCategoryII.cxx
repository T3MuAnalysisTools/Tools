#include "MakeMVATreeCategoryII.h"
...
MakeMVATreeCategoryII::MakeMVATreeCategoryII(TString Name_, TString id_):
    Selection(Name_,id_),
    tauMinMass_(1.731),
    tauMaxMass_(1.823),
...
MakeMVATreeCategoryII::~MakeMVATreeCategoryII(){
...
void  MakeMVATreeCategoryII::Configure(){
  // Set tree branches
...
void  MakeMVATreeCategoryII::Store_ExtraDist(){ 
...
void  MakeMVATreeCategoryII::doEvent(){ 
    unsigned int t;
    int id(Ntp->GetMCID());
    bool hlt_pass = false;
...
void  MakeMVATreeCategoryII::Finish(){
