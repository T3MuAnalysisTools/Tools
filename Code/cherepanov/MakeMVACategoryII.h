#ifndef MakeMVACategoryII_h
#define MakeMVACategoryII_h
...
class MakeMVACategoryII : public Selection {

 public:
  MakeMVACategoryII(TString Name_, TString id_);
  virtual ~MakeMVACategoryII();
