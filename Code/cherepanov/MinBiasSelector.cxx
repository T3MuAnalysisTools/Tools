...
MinBiasSelector::MinBiasSelector(TString Name_, TString id_):
  Selection(Name_,id_),
  tauMinMass_(1.70),
  tauMaxMass_(1.82),
  tauMinSideBand_(1.6),
...
MinBiasSelector::~MinBiasSelector(){
...
void  MinBiasSelector::Configure(){
  ...
  reader->BookMVA( "BDT", basedir+"NewTMVAClassification_8_BDT.weights.xml" ); // weights xml file after training, place it to CommonFiles
...
void  MinBiasSelector::Store_ExtraDist(){ 
