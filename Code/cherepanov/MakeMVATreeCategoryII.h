#ifndef MakeMVATreeCategoryII_h
#define MakeMVATreeCategoryII_h
...
class MakeMVATreeCategoryII : public Selection {

 public:
  MakeMVATreeCategoryII(TString Name_, TString id_);
  virtual ~MakeMVATreeCategoryII();
