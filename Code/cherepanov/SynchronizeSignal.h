...
class SignalSelector : public Selection {
 ...
 public:
  ...
  enum cuts {TriggerOk=0, SignalCandidate, VertChi2, Mu1PtCut, Mu2PtCut, Mu3PtCut, MuonID, PhiVeto, OmegaVeto, TriggerMatch1, TriggerMatch2,TriggerMatch3,TauMassCut,NCuts}; 
