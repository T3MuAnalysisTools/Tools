...
class IsoTracks : public Selection {

 public:
  IsoTracks(TString Name_, TString id_);
  virtual ~IsoTracks();
 ...
 private:
  ...
  std::vector<TH1D> PairFittedVertex_allCombinations;
  std::vector<TH1D> PairFitted_WithMus_Vertex_allCombinations;
  std::vector<TH1D> PairVPV_VectorSVPV_allCombinations;
  std::vector<TH1D> PairVPV_VectorTarckSum_allCombinations;
  std::vector<TH1D> SV_TrackVertex_Significance_allCombinations;

  std::vector<TH1D> PairFittedVertex_Matched2Prong;
  std::vector<TH1D>  PairFitted_WithMus_Vertex_Matched2Prong;
  std::vector<TH1D> PairVPV_VectorSVPV_Matched2Prong;
  std::vector<TH1D> PairVPV_VectorTarckSum_Matched2Prong;
  std::vector<TH1D> SV_TrackVertex_Significance_Matched2Prong;
  ...
  std::vector<TH1D>  N_MC_ConeTracksOfInterest;
  std::vector<TH1D>  NoOfIsolationTracks_Total;
  ...
  std::vector<TH1D>  TwoProngCategory_N_CorrectlyFoundTracks;
