...
class SignalSelector : public Selection {
 ...
 private:
  ...
  std::vector<TH1D> BDTOutput_train0_A;
  std::vector<TH1D> BDTOutput_train1_A;
  std::vector<TH1D> BDTOutput_train2_A;
  std::vector<TH1D> BDTOutput_train3_A;
  std::vector<TH1D> BDTOutput_train4_A;
  std::vector<TH1D> BDTOutput_train5_A;
  std::vector<TH1D> BDTOutput_train6_A;
  std::vector<TH1D> BDTOutput_train7_A;
  std::vector<TH1D> BDTOutput_train8_A;
  std::vector<TH1D> BDTOutput_train9_A;
  std::vector<TH1D> BDTOutput_train10_A;
  std::vector<TH1D> BDTOutput_train11_A;
  std::vector<TH1D> BDTOutput_train12_A;
  std::vector<TH1D> BDTOutput_train13_A;
  std::vector<TH1D> BDTOutput_train14_A;
  std::vector<TH1D> BDTOutput_train15_A;
  std::vector<TH1D> BDTOutput_train16_A;
  std::vector<TH1D> BDTOutput_train17_A;
  std::vector<TH1D> BDTOutput_train18_A;
  std::vector<TH1D> BDTOutput_train19_A;


  std::vector<TH1D> BDTOutput_train0_B;
  std::vector<TH1D> BDTOutput_train1_B;
  std::vector<TH1D> BDTOutput_train2_B;
  std::vector<TH1D> BDTOutput_train3_B;
  std::vector<TH1D> BDTOutput_train4_B;
  std::vector<TH1D> BDTOutput_train5_B;
  std::vector<TH1D> BDTOutput_train6_B;
  std::vector<TH1D> BDTOutput_train7_B;
  std::vector<TH1D> BDTOutput_train8_B;
  std::vector<TH1D> BDTOutput_train9_B;
  std::vector<TH1D> BDTOutput_train10_B;
  std::vector<TH1D> BDTOutput_train11_B;
  std::vector<TH1D> BDTOutput_train12_B;
  std::vector<TH1D> BDTOutput_train13_B;
  std::vector<TH1D> BDTOutput_train14_B;
  std::vector<TH1D> BDTOutput_train15_B;
  std::vector<TH1D> BDTOutput_train16_B;
  std::vector<TH1D> BDTOutput_train17_B;
  std::vector<TH1D> BDTOutput_train18_B;
  std::vector<TH1D> BDTOutput_train19_B;

  std::vector<TH1D> BDTOutput_train0_C;
  std::vector<TH1D> BDTOutput_train1_C;
  std::vector<TH1D> BDTOutput_train2_C;
  std::vector<TH1D> BDTOutput_train3_C;
  std::vector<TH1D> BDTOutput_train4_C;
  std::vector<TH1D> BDTOutput_train5_C;
  std::vector<TH1D> BDTOutput_train6_C;
  std::vector<TH1D> BDTOutput_train7_C;
  std::vector<TH1D> BDTOutput_train8_C;
  std::vector<TH1D> BDTOutput_train9_C;
  std::vector<TH1D> BDTOutput_train10_C;
  std::vector<TH1D> BDTOutput_train11_C;
  std::vector<TH1D> BDTOutput_train12_C;
  std::vector<TH1D> BDTOutput_train13_C;
  std::vector<TH1D> BDTOutput_train14_C;
  std::vector<TH1D> BDTOutput_train15_C;
  std::vector<TH1D> BDTOutput_train16_C;
  std::vector<TH1D> BDTOutput_train17_C;
  std::vector<TH1D> BDTOutput_train18_C;
  std::vector<TH1D> BDTOutput_train19_C;


  std::vector<TH2D> TauMass_vs_BDT_train0_A;
  std::vector<TH2D> TauMass_vs_BDT_train1_A;
  std::vector<TH2D> TauMass_vs_BDT_train2_A;
  std::vector<TH2D> TauMass_vs_BDT_train3_A;
  std::vector<TH2D> TauMass_vs_BDT_train4_A;
  std::vector<TH2D> TauMass_vs_BDT_train5_A;
  std::vector<TH2D> TauMass_vs_BDT_train6_A;
  std::vector<TH2D> TauMass_vs_BDT_train7_A;
  std::vector<TH2D> TauMass_vs_BDT_train8_A;
  std::vector<TH2D> TauMass_vs_BDT_train9_A;
  std::vector<TH2D> TauMass_vs_BDT_train10_A;
  std::vector<TH2D> TauMass_vs_BDT_train11_A;
  std::vector<TH2D> TauMass_vs_BDT_train12_A;
  std::vector<TH2D> TauMass_vs_BDT_train13_A;
  std::vector<TH2D> TauMass_vs_BDT_train14_A;
  std::vector<TH2D> TauMass_vs_BDT_train15_A;
  std::vector<TH2D> TauMass_vs_BDT_train16_A;
  std::vector<TH2D> TauMass_vs_BDT_train17_A;
  std::vector<TH2D> TauMass_vs_BDT_train18_A;
  std::vector<TH2D> TauMass_vs_BDT_train19_A;



  std::vector<TH2D> TauMass_vs_BDT_train0_B;
  std::vector<TH2D> TauMass_vs_BDT_train1_B;
  std::vector<TH2D> TauMass_vs_BDT_train2_B;
  std::vector<TH2D> TauMass_vs_BDT_train3_B;
  std::vector<TH2D> TauMass_vs_BDT_train4_B;
  std::vector<TH2D> TauMass_vs_BDT_train5_B;
  std::vector<TH2D> TauMass_vs_BDT_train6_B;
  std::vector<TH2D> TauMass_vs_BDT_train7_B;
  std::vector<TH2D> TauMass_vs_BDT_train8_B;
  std::vector<TH2D> TauMass_vs_BDT_train9_B;
  std::vector<TH2D> TauMass_vs_BDT_train10_B;
  std::vector<TH2D> TauMass_vs_BDT_train11_B;
  std::vector<TH2D> TauMass_vs_BDT_train12_B;
  std::vector<TH2D> TauMass_vs_BDT_train13_B;
  std::vector<TH2D> TauMass_vs_BDT_train14_B;
  std::vector<TH2D> TauMass_vs_BDT_train15_B;
  std::vector<TH2D> TauMass_vs_BDT_train16_B;
  std::vector<TH2D> TauMass_vs_BDT_train17_B;
  std::vector<TH2D> TauMass_vs_BDT_train18_B;
  std::vector<TH2D> TauMass_vs_BDT_train19_B;



  std::vector<TH2D> TauMass_vs_BDT_train0_C;
  std::vector<TH2D> TauMass_vs_BDT_train1_C;
  std::vector<TH2D> TauMass_vs_BDT_train2_C;
  std::vector<TH2D> TauMass_vs_BDT_train3_C;
  std::vector<TH2D> TauMass_vs_BDT_train4_C;
  std::vector<TH2D> TauMass_vs_BDT_train5_C;
  std::vector<TH2D> TauMass_vs_BDT_train6_C;
  std::vector<TH2D> TauMass_vs_BDT_train7_C;
  std::vector<TH2D> TauMass_vs_BDT_train8_C;
  std::vector<TH2D> TauMass_vs_BDT_train9_C;
  std::vector<TH2D> TauMass_vs_BDT_train10_C;
  std::vector<TH2D> TauMass_vs_BDT_train11_C;
  std::vector<TH2D> TauMass_vs_BDT_train12_C;
  std::vector<TH2D> TauMass_vs_BDT_train13_C;
  std::vector<TH2D> TauMass_vs_BDT_train14_C;
  std::vector<TH2D> TauMass_vs_BDT_train15_C;
  std::vector<TH2D> TauMass_vs_BDT_train16_C;
  std::vector<TH2D> TauMass_vs_BDT_train17_C;
  std::vector<TH2D> TauMass_vs_BDT_train18_C;
  std::vector<TH2D> TauMass_vs_BDT_train19_C;
  ...
  std::vector<TH2D> TauMass_allVsBDTABC;
  ...
  TMVA::Reader *reader_train0_A;
  TMVA::Reader *reader_train0_B;
  TMVA::Reader *reader_train0_C;


  TMVA::Reader *reader_train1_A;
  TMVA::Reader *reader_train1_B;
  TMVA::Reader *reader_train1_C;


  TMVA::Reader *reader_train2_A;
  TMVA::Reader *reader_train2_B;
  TMVA::Reader *reader_train2_C;


  TMVA::Reader *reader_train3_A;
  TMVA::Reader *reader_train3_B;
  TMVA::Reader *reader_train3_C;


  TMVA::Reader *reader_train4_A;
  TMVA::Reader *reader_train4_B;
  TMVA::Reader *reader_train4_C;


  TMVA::Reader *reader_train5_A;
  TMVA::Reader *reader_train5_B;
  TMVA::Reader *reader_train5_C;


  TMVA::Reader *reader_train6_A;
  TMVA::Reader *reader_train6_B;
  TMVA::Reader *reader_train6_C;


  TMVA::Reader *reader_train7_A;
  TMVA::Reader *reader_train7_B;
  TMVA::Reader *reader_train7_C;


  TMVA::Reader *reader_train8_A;
  TMVA::Reader *reader_train8_B;
  TMVA::Reader *reader_train8_C;


  TMVA::Reader *reader_train9_A;
  TMVA::Reader *reader_train9_B;
  TMVA::Reader *reader_train9_C;


  TMVA::Reader *reader_train10_A;
  TMVA::Reader *reader_train10_B;
  TMVA::Reader *reader_train10_C;


  TMVA::Reader *reader_train11_A;
  TMVA::Reader *reader_train11_B;
  TMVA::Reader *reader_train11_C;


  TMVA::Reader *reader_train12_A;
  TMVA::Reader *reader_train12_B;
  TMVA::Reader *reader_train12_C;


  TMVA::Reader *reader_train13_A;
  TMVA::Reader *reader_train13_B;
  TMVA::Reader *reader_train13_C;


  TMVA::Reader *reader_train14_A;
  TMVA::Reader *reader_train14_B;
  TMVA::Reader *reader_train14_C;


  TMVA::Reader *reader_train15_A;
  TMVA::Reader *reader_train15_B;
  TMVA::Reader *reader_train15_C;


  TMVA::Reader *reader_train16_A;
  TMVA::Reader *reader_train16_B;
  TMVA::Reader *reader_train16_C;


  TMVA::Reader *reader_train17_A;
  TMVA::Reader *reader_train17_B;
  TMVA::Reader *reader_train17_C;


  TMVA::Reader *reader_train18_A;
  TMVA::Reader *reader_train18_B;
  TMVA::Reader *reader_train18_C;


  TMVA::Reader *reader_train19_A;
  TMVA::Reader *reader_train19_B;
  TMVA::Reader *reader_train19_C;


  TMVA::Reader *reader_train20_A;
  TMVA::Reader *reader_train20_B;
  TMVA::Reader *reader_train20_C;
  ...
  Float_t var_segCompMuMax;// (Minimum of the segment compatibility of the three muons)
