#ifndef SignalSelectorArunTwo_h
#define SignalSelectorArunTwo_h
...
class SignalSelectorArunTwo : public Selection {

 public:
  SignalSelectorArunTwo(TString Name_, TString id_);
  virtual ~SignalSelectorArunTwo();
 ...
 private:
  ...
  //initializing histograms from bhargav
