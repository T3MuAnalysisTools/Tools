#ifndef ZTau3MuTaue_Skimmer_h
#define ZTau3MuTaue_Skimmer_h
...
class ZTau3MuTaue_Skimmer : public Selection {

 public:
  ZTau3MuTaue_Skimmer(TString Name_, TString id_);
  virtual ~ZTau3MuTaue_Skimmer();
