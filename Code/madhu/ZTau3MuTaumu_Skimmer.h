#ifndef ZTau3MuTaumu_Skimmer_h
#define ZTau3MuTaumu_Skimmer_h
...
class ZTau3MuTaumu_Skimmer : public Selection {

 public:
  ZTau3MuTaumu_Skimmer(TString Name_, TString id_);
  virtual ~ZTau3MuTaumu_Skimmer();
