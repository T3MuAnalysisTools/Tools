...
ZTau3MuTaumu_PreFC::ZTau3MuTaumu_PreFC(TString Name_, TString id_):
  Selection(Name_,id_)
{
  // This is a class constructor;
}

ZTau3MuTaumu_PreFC::~ZTau3MuTaumu_PreFC(){
...
void  ZTau3MuTaumu_PreFC::Configure(){
  ...
  for(int i=0; i<NCuts;i++){
    ...
    if(i==Tau_mu_Candidate_p)       cut.at(Tau_mu_Candidate_p)=2.5;
  ...
  Whether_Tau_mu_fiducial_and_reco=HConfig.GetTH2D(Name+"_Whether_Tau_mu_fiducial_and_reco","Whether_Tau_mu_fiducial_and_reco",2,-0.5,1.5,2,-0.5,1.5,"Whether spect tau fiducial","Whether spect tau reco");
  ...
  Selection_Cut_mu_p_eta_before=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_before","Selection_Cut_mu_p_eta_before",200,0.0,100.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  Selection_Cut_mu_p_eta_after=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_after","Selection_Cut_mu_p_eta_after",200,0.0,100.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  Selection_Cut_mu_p_eta_after_reco=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_after_reco","Selection_Cut_mu_p_eta_after_reco",200,0.0,100.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  Selection_Cut_mu_p_eta_after_noreco=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_after_noreco","Selection_Cut_mu_p_eta_after_noreco",200,0.0,100.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  Selection_Cut_mu_p_eta_after_trigger=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_after_trigger","Selection_Cut_mu_p_eta_after_trigger",200,0.0,100.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  
  Selection_Cut_Mu1_dR=HConfig.GetTH1D(Name+"_Selection_Cut_Mu1_dR","Selection_Cut_Mu1_dR",200,0,0.05,"#Delta R","Events");
  Selection_Cut_Mu2_dR=HConfig.GetTH1D(Name+"_Selection_Cut_Mu2_dR","Selection_Cut_Mu2_dR",200,0,0.05,"#Delta R","Events");
  Selection_Cut_Mu3_dR=HConfig.GetTH1D(Name+"_Selection_Cut_Mu3_dR","Selection_Cut_Mu3_dR",200,0,0.05,"#Delta R","Events");
  Selection_Cut_mu_dR=HConfig.GetTH1D(Name+"_Selection_Cut_mu_dR","Selection_Cut_mu_dR",200,0,0.075,"#Delta R","Events");
...
void  ZTau3MuTaumu_PreFC::Store_ExtraDist(){ 
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  Extradist2d.push_back(&Whether_Tau_mu_fiducial_and_reco);
  ...
  Extradist2d.push_back(&Selection_Cut_mu_p_eta_after_noreco);
  Extradist2d.push_back(&Selection_Cut_mu_p_eta_after_trigger);
...
void  ZTau3MuTaumu_PreFC::doEvent(){ 
  ...
  for(unsigned int imu=0; imu < Ntp->NMuons() ; imu++)
    {
      ...
      if(signal_idx!=-1){
              ...
              if(Ntp->Muon_P4(imu).DeltaR(Muon_LV)<dR4_max&&WhetherMuonDifferentFrom3Mu){
  ...
  if(id==210232){
          ...
          if(Whether_decay_found){
                  ...
                  */
                  ...
                  if(L1Ok&&HLTOk){
                    Selection_Cut_mu_p_eta_after_trigger.at(t).Fill(Muon_LV.Vect().Mag(),abs(Muon_LV.Eta()));
                  }
                  }
                  */
                  ...
                  //Non-Sequential
                  bool whether_4_obj_reco = pass.at(Mu1_Candidate_recod) && pass.at(Mu2_Candidate_recod) && pass.at(Mu3_Candidate_recod) && pass.at(Tau_mu_Candidate_recod);
                  bool whether_4_obj_fiducial = pass.at(Mu1_Candidate_p)&&pass.at(Mu1_Candidate_eta) && pass.at(Mu2_Candidate_p)&&pass.at(Mu2_Candidate_eta) && pass.at(Mu3_Candidate_p)&&pass.at(Mu3_Candidate_eta) && pass.at(Tau_mu_Candidate_p)&&pass.at(Tau_mu_Candidate_eta);
                  ...
                  Selection_Cut_mu_p_eta_before.at(t).Fill(Muon_LV.Pt(),abs(Muon_LV.Eta()));
                  if(pass.at(Tau_mu_Candidate_p)&&pass.at(Tau_mu_Candidate_eta)){
                    Selection_Cut_mu_p_eta_after.at(t).Fill(Muon_LV.Pt(),abs(Muon_LV.Eta()));
                  }
                  if(pass.at(Tau_mu_Candidate_recod)){
                      Selection_Cut_mu_p_eta_after_reco.at(t).Fill(Muon_LV.Pt(),abs(Muon_LV.Eta()));
                  }
                  if(pass.at(Tau_mu_Candidate_p)&&pass.at(Tau_mu_Candidate_eta)&&!pass.at(Tau_mu_Candidate_recod)){
                      Selection_Cut_mu_p_eta_after_noreco.at(t).Fill(Muon_LV.Pt(),abs(Muon_LV.Eta()));
                      //std::cout<<"Reco Muon_LV p: "<< Muon_LV.Pt() <<" pT: "<< Muon_LV.Pt() << " dRmin: "<< dR4_max << std::endl;
                  }
                  if(L1Ok&&HLTOk){
                    Selection_Cut_mu_p_eta_after_trigger.at(t).Fill(Muon_LV.Pt(),abs(Muon_LV.Eta()));
                  }
                  Whether_Tau_mu_fiducial_and_reco.at(t).Fill(pass.at(Tau_mu_Candidate_p)&&pass.at(Tau_mu_Candidate_eta) , pass.at(Tau_mu_Candidate_recod));
...
void  ZTau3MuTaumu_PreFC::Finish(){
