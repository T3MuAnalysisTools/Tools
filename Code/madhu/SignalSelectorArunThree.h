#ifndef SignalSelectorArunThree_h
#define SignalSelectorArunThree_h
...
class SignalSelectorArunThree : public Selection {

 public:
  SignalSelectorArunThree(TString Name_, TString id_);
  virtual ~SignalSelectorArunThree();
  ...
  enum cuts {TriggerOk=0,SignalCandidate, Mu1PtCut, Mu2PtCut, Mu3PtCut, TriggerMatchMu1, TriggerMatchMu2, TriggerMatchMu3, MuonID, PVRefit, PhiVetoOS1, OmegaVetoOS1, PhiVetoOS2,  OmegaVetoOS2, TauMassCut, DsGenMatch, GenMatch, NCuts,PrimeVtx,LeadingMuonPt,LeadingMuonPt1,LeadingMuonPt2, PhiVeto, OmegaVeto};
 ...
 private:
  ...
  //Initialize bhargav's histograms
