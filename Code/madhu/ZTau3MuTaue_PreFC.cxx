...
void  ZTau3MuTaue_PreFC::Configure(){
  ...
  for(int i=0; i<NCuts;i++){
    ...
    if(i==Tau_e_Candidate_eta)      cut.at(Tau_e_Candidate_eta)=2.51;
  ...
  for(int i=0; i<NCuts; i++){
    ...
    if(i==L1_TriggerOk){
      ...
      title.at(i)=" Whether GEN level $e$ has $|\\eta| < 2.51$ ";
      hlabel="$\\tau_{e}$ $|\\eta|$";
      htitle.ReplaceAll("$","");
      htitle.ReplaceAll("\\","#");
  ...
  Selection_Cut_El_dR=HConfig.GetTH1D(Name+"_Selection_Cut_El_dR","Selection_Cut_El_dR",200,0,0.075,"#Delta R","Events");
...
void  ZTau3MuTaue_PreFC::doEvent(){ 
  ...
  pass.at(Tau_e_Candidate_eta)=value.at(Tau_e_Candidate_eta)<cut.at(Tau_e_Candidate_eta) && !(value.at(Tau_e_Candidate_eta)<1.57&&value.at(Tau_e_Candidate_eta)>1.44);
  ...
  if(id==210231){
          ...
          if(Whether_decay_found){
                  ...
                  */
                  ...
                  bool whether_4_obj_fiducial = pass.at(Mu1_Candidate_p)&&pass.at(Mu1_Candidate_eta) && pass.at(Mu2_Candidate_p)&&pass.at(Mu2_Candidate_eta) && pass.at(Mu3_Candidate_p)&&pass.at(Mu3_Candidate_eta) && pass.at(Tau_e_Candidate_p)&&pass.at(Tau_e_Candidate_eta);
