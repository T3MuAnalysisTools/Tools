#ifndef ZTau3MuTaue_Efficiency_h
#define ZTau3MuTaue_Efficiency_h
...
class ZTau3MuTaue_Efficiency : public Selection {

 public:
  ZTau3MuTaue_Efficiency(TString Name_, TString id_);
  virtual ~ZTau3MuTaue_Efficiency();
